...
public class WriteExcel {
  ...
  public static class SendMessages {
    private static String sender = "tda.public@gmail.com";
    private static String subject = "Weekly AWS Status Report";
    private static String bodyText =
        "Hello,\r\n\r\nPlease see the attached file for a weekly update.";
    private static String bodyHTML =
        "<!DOCTYPE html><html lang=\"en-US\"><body><h1>Hello!</h1><p>Please see the attached "
            + "file for a weekly update.</p></body></html>";
    ...
    public void send(MimeMessage message) throws MessagingException, IOException {
      ...
      try {
        ...
        SesClient client = SesClient.builder().region(APP_REGION).build();
    ...
    private MimeMessage makeEmail(byte[] attachment, String emailAddress)
      ...
      DataSource fds =
          new ByteArrayDataSource(
              attachment, "application/vnc.openxmlformats-officedocument.spreadsheetml.sheet");
